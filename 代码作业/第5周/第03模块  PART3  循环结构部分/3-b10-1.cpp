...
int main()
{
	...
	for (int i = 123; i <= 987; i++) {
		...
		for (int j = i + 1; j <= 987; j++) {
			...
			if (k1 == 0 || k2 == 0 || k3 == 0 || k1 == k2 || k1 == k3 || k2 == k3) 
				continue;
			if (k1 == i1 || k1 == i2 || k1 == i3 || k1 == j1 || k1 == j2 || k1 == j3 ||
				k2 == i1 || k2 == i2 || k2 == i3 || k2 == j1 || k2 == j2 || k2 == j3 ||
				k3 == i1 || k3 == i2 || k3 == i3 || k3 == j1 || k3 == j2 || k3 == j3) 
				continue;
			if (k > j) {
				total += 1;
